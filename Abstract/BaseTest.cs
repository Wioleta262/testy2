...
namespace Tests.Abstract
{
    public abstract class BaseTest : IDisposable
    {
        ...
        public static TimeSpan Preset60SecondExplicitWaitTimeout => TimeSpan.FromSeconds(60);
        public virtual TimeSpan DefaultExplicitWaitTimeout => Preset60SecondExplicitWaitTimeout;
